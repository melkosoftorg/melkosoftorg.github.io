...
*/
  ...
  var LEVEL = {
      ...
      TXT: {
        ...
        // intro-text
        'intro' : [ {
                        title: 'Вы открываете глаза в темной, незнакомой комнате.',
                        body: ['твое последнее воспоминание-свист стрел, ',
                               'когда на твой караван безжалостно напали. Где вас схватили? ',
                               'Кто ты и где ты сейчас находишься?']
                    },

                    {
                      title: 'вы чувствуете безмерную усталость.',
                      body: ['Когда вы двигаете языком в сухом рту, вы отшатываетесь, заметив, ',
                             'что теперь у вас меньше зубов, чем раньше.',
                             'Ты быстро берешь себя в руки и щуришь глаза, пытаясь осмыслить ',
                             'окружающее. Должен же быть какой-то выход.']
                    },
